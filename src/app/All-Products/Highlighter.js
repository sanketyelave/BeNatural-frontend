...
export default function Highlighter() {
    ...
    return (
        <div>
            ...
            <h2 className="heading-primary" style={{ textAlign: 'center', marginTop: '5rem', marginBottom: '3rem', color: '#54731a' }} ><span style={{ color: '#86bc25' }}>Highlighter</span> Here</h2>
            {loading ? (
                <LoadingPage />
            ) : (
                <div className="container grid grid--3-cols margin-bottom-md">
                    {products.map((product) => product.type === 'Highlighter' && (
